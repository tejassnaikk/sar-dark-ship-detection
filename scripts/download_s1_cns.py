"""
Download the locked Central North Sea offshore scene (2026-05-05).

Usage — run in your terminal with credentials already exported:
    cd "/Volumes/Tejas SSD/sar-dark-ship-detection"
    source .venv/bin/activate
    caffeinate -i python scripts/download_s1_cns.py
...
# ── Target product ─────────────────────────────────────────────────────────
PRODUCT_ID   = "76df1f03-82dc-44ce-946c-e55590e9d2f6"
...
print("\nNext step:")
print("  python scripts/preview_cns.py")
